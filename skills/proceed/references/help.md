...
| `GH_TRUSTED_HARNESSES` | `claude codex` | Space-separated allow-list for the 2.1.1b origin gate. An explicitly empty value trusts nobody. Family-wide name (issue #44 D-3); policy in `references/origin-trust.md`. |
